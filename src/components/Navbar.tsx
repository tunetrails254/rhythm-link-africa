      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#teachers" className="text-muted-foreground hover:text-foreground transition-colors font-medium">
              For Teachers
            </a>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-border/50 animate-fade-in">
            <div className="flex flex-col gap-4">
              ...
              <a href="#teachers" className="text-muted-foreground hover:text-foreground transition-colors font-medium py-2">
                For Teachers
              </a>
